  ...
  return (
    <div id="upload-pdf">
      ...
      <div id="stuff-nl">
        ...
        <button id="upload-file" onClick={handleUpload}>
          Upload
        </button>
      </div>
            ...
            <div className="newsletter-item" key={index}>
              <div className="info-container">
                <p className="letter-info">
                  ...
                  <a
                    onClick={() => {
                      downloadPdf(newsletter._id, newsletter.pdf_name);
                    }}
                    download={newsletter.pdf_name}
                  >
                    <img
                      id="download-img"
                ...
                {letterStates[newsletter._id] === 1 ? (
                  <>
                    <button
                      className="delete-nl"
                      id="confirm-delete"
                      style={{ backgroundColor: "#cd8783fc" }}
                    ...
                    <button
                      className="cancel-b"
                      id="delete1"
                      style={{ backgroundColor: "#a2a2a3" }}
                      onClick={() => handleCancel(newsletter._id)}
                    >
                      Cancel
                    </button>
                  </>
