...
router.route("/user/changePassword").post(async (req, res) => {
...
router.route("/user/updatePfp").post(verifyToken, async (req, res) => {
  const { pfp } = req.body;
...
router
  .route("/user/changePassword/:userID/:uniqueString")
  .get(async (req, res) => {
...
router
  .route("/user/changePassword/:userID/:uniqueString/setPassword")
  .post(async (req, res) => {
    const uniqueString = req.params.uniqueString;
    const userID = req.params.userID.trim();
        ...
        bcrypt
          ...
          .then(async (result) => {
            if (result) {
              ...
              let oresult = await User.updateOne(
...
router.route("/user/details").get(verifyToken, async (req, res) => {
